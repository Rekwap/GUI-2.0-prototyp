import svgPaths from "./svg-cap7qpdye7";
  ...
  return (
    <div className="absolute h-[27px] left-[180px] top-[127px] w-[88px]">
      <div className="absolute flex flex-col font-['Noto_Sans:Display_Medium',_sans-serif] font-medium justify-center leading-[0] left-1/2 text-[#191c24] text-[20px] text-center top-1/2 translate-x-[-50%] translate-y-[-50%] w-[88px]" style={{ fontVariationSettings: "'CTGR' 100, 'wdth' 100" }}>
        <p className="leading-[normal]">kg</p>
      </div>
    </div>
  );
}
  ...
  return (
    <div className="absolute bg-white bottom-[256px] h-[166px] left-1/2 rounded-[6px] translate-x-[-50%] w-[268px]" data-name="Menu Item">
      <div className="h-[166px] overflow-clip relative rounded-[inherit] w-[268px]">
        <Close50X50 />
        <div className="absolute flex flex-col font-['Noto_Sans:Display_SemiBold',_sans-serif] font-semibold justify-center leading-[0] left-[calc(50%+0.5px)] text-[36px] text-black text-center text-nowrap top-[calc(50%-0.5px)] translate-x-[-50%] translate-y-[-50%]" style={{ fontVariationSettings: "'CTGR' 100, 'wdth' 100" }}>
          <p className="leading-[normal] whitespace-pre">-9.50</p>
        </div>
        <Frame1109 />
      </div>
...
function KeyboardBack24X24() {
  return (
    <div className="absolute left-[calc(50%+0.5px)] overflow-clip size-[24px] top-1/2 translate-x-[-50%] translate-y-[-50%]" data-name="keyboard_back_24x24">
      <Backspace />
    </div>
  );
}
...
function Component() {
  return (
    <div className="absolute bg-[#c9cacb] bottom-[2px] h-[60px] left-[2px] rounded-[6px] w-[61px]" data-name=".">
      <div className="h-[60px] overflow-clip relative rounded-[inherit] w-[61px]">
        <KeyboardBack24X24 />
      </div>
...
function Group1094() {
  return (
    <div className="absolute bottom-[2px] contents left-[2px]">
      <Component />
    </div>
  );
}
...
function Frame1095() {
  return (
    <div className="absolute bg-white bottom-[2px] h-[60px] left-[calc(50%-58.5px)] rounded-[6px] translate-x-[-50%] w-[25px]">
      <div aria-hidden="true" className="absolute border border-[#d3d4d7] border-solid inset-0 pointer-events-none rounded-[6px]" />
    </div>
  );
}
...
function Group1204() {
  return (
    <div className="absolute contents left-[calc(50%-58.5px)] top-[418px] translate-x-[-50%]">
      <Frame1095 />
      <p className="absolute font-['Noto_Sans:Display_Medium',_sans-serif] font-medium h-[49.286px] leading-[normal] left-[calc(50%-59px)] text-[#191c24] text-[24px] text-center top-[calc(50%+187.644px)] translate-x-[-50%] w-[14px]" style={{ fontVariationSettings: "'CTGR' 100, 'wdth' 100" }}>
        .
      </p>
    </div>
  );
...
export default function Component36PtSemibold() {
  return (
    <div className="bg-[#e7ebf7] relative shadow-[0px_4px_4px_0px_rgba(0,0,0,0.25)] size-full" data-name="36pt semibold">
      <PortraitHeaderWhite />
      <MenuItem />
      <Group969 />
