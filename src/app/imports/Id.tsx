import svgPaths from "./svg-syn7lgmvua";
import { imgArrowForwardIos } from "./svg-wh3ok";
  ...
  return (
    <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 80 80">
      <g id="user green 80 x 80 px">
        <mask height="80" id="mask0_3_3467" maskUnits="userSpaceOnUse" style={{ maskType: "alpha" }} width="80" x="0" y="0">
        ...
        <mask height="41" id="mask1_3_3467" maskUnits="userSpaceOnUse" style={{ maskType: "alpha" }} width="40" x="40" y="39">
          <rect fill="var(--fill-0, #D9D9D9)" height="40" id="Bounding box_2" width="40" x="40" y="39.9995" />
        </mask>
        <g mask="url(#mask1_3_3467)">
...
function Next({ onClick }: { onClick: () => void }) {
  return (
    <button onClick={onClick} className="absolute bg-white h-[56px] left-[8px] overflow-clip rounded-[8px] shadow-[0px_2px_6px_0px_#191c24] top-[416px] w-[256px] cursor-pointer hover:bg-gray-50 transition-colors" data-name="Next">
...
export default function Id({ onClose, onNext }: { onClose: () => void; onNext: () => void }) {
  ...
  return (
    <div className="bg-white relative shadow-[0px_4px_10px_2px_rgba(155,161,179,0.4)] w-[272px] h-[480px]" data-name="ID">
      ...
      <p className="absolute font-['Noto_Sans:Display_Medium',_sans-serif] font-medium leading-[normal] left-1/2 text-[#191c24] text-[16px] text-center top-[309px] translate-x-[-50%] w-[248px]" style={{ fontVariationSettings: "'CTGR' 100, 'wdth' 100" }}>
        1995/07/24
      </p>
    </div>
  );
