...
import svgPaths from "./svg-zrmni6k3os";
import ProgressHeigthMeasurementIcon from "./ProgressHeigthMeasurement";
import ProgressHeigthMeasurementMid from "./ProgressHeigthMeasurement-90-280";
import ProgressHeigthMeasurementTop from "./ProgressHeigthMeasurement-90-317";

interface HeightMeasurementOngoingProps {
  onClose: () => void;
  ...
  return (
    <div className="relative shrink-0 size-[32px]" data-name="close">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 32 32">
        <g id="close">
          <mask height="32" id="mask0_148_1047" maskUnits="userSpaceOnUse" style={{ maskType: "alpha" }} width="32" x="0" y="0">
            <rect fill="var(--fill-0, #D9D9D9)" height="32" id="Bounding box" width="32" />
          </mask>
          <g mask="url(#mask0_148_1047)">
...
export default function HeightMeasurementOngoing({ onClose, onMeasured, targetHeight = '167.7' }: HeightMeasurementOngoingProps) {
  ...
  return (
    <div className="bg-white relative shadow-[0px_4px_10px_2px_rgba(155,161,179,0.4)] size-full" data-name="Scan Patient ID">
      ...
      <div className="absolute left-1/2 size-[80px] top-[96px] translate-x-[-50%]">
