import svgPaths from "./svg-5xnqv7x4ie";
import { imgHistory2 } from "./svg-cq2xr";
...
function Group() {
  return (
    <div className="h-[30px] relative shrink-0 w-[22.183px]">
...
function ProgressHeigthMeasurement() {
  return (
    <div className="absolute bg-white box-border content-stretch flex gap-[10px] items-center left-[calc(50%+0.092px)] px-[30px] py-[8px] rounded-[54px] shadow-[0px_2px_6px_0px_#191c24] top-[24px] translate-x-[-50%]" data-name="Progress Heigth Measurement">
      <Group />
